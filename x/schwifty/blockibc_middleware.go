...
// IBCMiddleware implements the schwifty keeper in order to check againset blacklisted addresses.
...
func (im IBCMiddleware) OnRecvPacket(
	...
	if err := types.ModuleCdc.UnmarshalJSON(packet.GetData(), &data); err != nil {
		ackErr = sdkerrors.Wrapf(sdkerrors.ErrInvalidType, "cannot unmarshal NFT transfer packet data")
