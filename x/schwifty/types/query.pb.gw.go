...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"toschdev", "schwifty", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"toschdev", "schwifty", "collection", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CollectionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"toschdev", "schwifty", "collection"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Nft_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"toschdev", "schwifty", "nft", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NftAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"toschdev", "schwifty", "nft"}, "", runtime.AssumeColonVerbOpt(true)))
)
